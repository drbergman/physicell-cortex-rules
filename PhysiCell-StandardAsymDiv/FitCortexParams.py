...
path_to_physicell = home_dir + "/physicell-cortex-rules/PhysiCell-StandardAsymDiv"
...
def runSimulationsAndError( x, parameters, layer_counts_data, parameter_order, min_replicates ):
    ...
    if isinstance(layer_counts_data, dict):
        ...
        # important that we loop over the data keys, since the simulated keys could include 2 and 3
